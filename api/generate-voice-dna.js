...
module.exports = async function handler(request, response) {
  ...
  try {
    ...
    const voiceDna = await callGrok([
      ...
      "Format the final answer as a useful Markdown file the user can copy or download.",
      "Start with a section titled: Simple summary. In that section, explain in simple sentences how this person sounds. Avoid jargon.",
      "Then include the thorough Voice DNA profile from the extractor.",
      "Then include a section titled: How to use this next time. Tell the user to attach this file or paste the prompt block whenever they use AI, so the AI can write closer to their real voice.",
      "Include five concrete use cases: social posts, emails, websites, blog articles, and future AI chats.",
